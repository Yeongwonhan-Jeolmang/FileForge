...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        self._metadata_tabs.tabBar().setExpanding(False)
        self._metadata_tabs.tabBar().setUsesScrollButtons(True)
        ...
        self._analysis_tabs.tabBar().setExpanding(False)
        self._analysis_tabs.tabBar().setUsesScrollButtons(True)
